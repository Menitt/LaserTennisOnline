...
public class LaserTennisOnline : ModuleRules
{
	public LaserTennisOnline(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange(new string[] { "Core", "CoreUObject", "Engine", "InputCore", "EnhancedInput","UMG", "MultiplayerSessions", "OnlineSubsystem", "OnlineSubsystemSteam"});
